...
export default class RPService {
	...
	sendRequest(url: string, method: string, data: any): Promise<any>{
		...
		return axios.post('https://linguatrash.fun/' + url, {method: method, data: data}, config).catch(function (error) {
		if (error.response) {
	...
	_login(username: any, password: any): Promise<any>{
		...
		return axios.post('https://linguatrash.fun/auth/jwt/create', bodyFormData)
	}
	...
	_sigup(username: any, password: any): Promise<any>{
		...
		return axios.post('https://linguatrash.fun/auth/users/', bodyFormData)
	}
	...
	getMeOnly(): Promise<any>{
		...
		return axios.post('https://linguatrash.fun/api/vocabulary/partner', {method: 'get_me', data: {}}, config)
	}
